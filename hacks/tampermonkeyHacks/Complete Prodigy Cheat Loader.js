...
(function() {
    ...
    function all(){
        ...
        if(hack.instance.prodigy.game.state.current === "Battle" && inBattle == false){inBattle = true; hack.instance.prodigy.game.state.states.Battle.startVictory(); setTimeout(function(){inBattle = false}, 30000); }
        }, 2);
    }
})();
