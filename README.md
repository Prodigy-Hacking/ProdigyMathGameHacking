...
Also working on hacks with `Object.keys(Object.getPrototypeOf(PIXI.game.prodigy.debugMisc)).join("\n")` debug functions, such as hacking the Dark Tower, gaining infinite conjure cubes, attaining limited-edition gear, and altering the level of yourself and your pets.

# Current work in progress: Obtaining relics through script. (I have no idea where to start)
