...
(async () => {
    ...
    level100button.onclick = function () {
        swal.fire("What level would you like to be?",'','question', {
            content: "input",
        })
            .then((value) => {
               if(value){
                modifyData(`playerdata.data.level = ${value}`)
                swal.fire('Success.', 'Your level has been applied.', 'success')
                .then((value) => {
                    swal.fire("Would you like to reload?", 'If not, press Esc.', 'info')
                    .then((value) => {
                        if (!value) return;
    ...
    goldbutton.onclick = function () {
        swal.fire("How much gold would you like?",'','question', {
            content: "input",
        })
            .then((value) => {
               if(value){
                modifyData(`playerdata.data.gold = ${value}`)
                swal.fire('Success.', 'Your gold has been added.', 'success')
                .then((value) => {
                    swal.fire("Would you like to reload?", 'If not, press Esc.', 'info')
                    .then((value) => {
                        if (!value) return;
...
},{"./utils/modifyData":5,"fs":1,"node-fetch":2,"sweetalert2":3}],5:[function(require,module,exports){
module.exports = {
...
},{"./parsetoken":6}],6:[function(require,module,exports){
module.exports = {
