To use this hack menu, simply go to the "Bookmarklet" file, make it a bookmarklet (or just copy and paste the raw script from the file "Hack Menu Script(Important!)")
